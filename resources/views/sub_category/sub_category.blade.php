...
<main class="pageWrapper">
			<div class="archiveWrapper">
				<div class="container">
					...
					<div class="offer-part brand-offer">
						<div class="catalog-heading brands-heading">
							<div class="row">
								<div class="col-md-6">
									<h1 class="catalog-heading__title brands-heading__title">{{ $repairSubCategory->title }}</h1>
				...
				<div class="section-like">
					<div class="container">
						<h2 class="catalog-h2">Нам доверяют ремонт </h2>
...
@section('description', $repairSubCategory->seo_description )
@section('keywords', $repairSubCategory->seo_keywords)
@section('title', $repairSubCategory->seo_title)