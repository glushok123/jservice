				...
				<div class="middleHeader">
					<div class="logoPart-header">
						<a href="/" class="custom-logo-link" rel="home" style='text-align: center;'>
							<img src="/images/JService1.png" alt="" style="height: 60px;" align='center' class="mx-auto" style='text-align: center;'>
						</a>
					</div>
										...
										<div class="dropDown_menu">
											<ul class>
												@foreach ($category->sub_category as $sub_category)
													...
													<li class="lvl_menu_1">
														<a href="{{ route('sub_category.show', ['slug_sub_category' => $sub_category->slug]) }}">{{ $sub_category->name}}</a>
														<div class="lvl_menu_2">
															<ul class="head-col-all head-column-4">
		
																@foreach ($sub_category->brands as $brand)
																	<li><a href="{{ route('sub_category.brand.show', ['slug_sub_category' => $sub_category->slug, 'slug_brand' => $brand->slug]) }}">{{ $brand->name }}</a></li>
																@endforeach
